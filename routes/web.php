...
Route::group(['prefix' => 'guru', 'middleware' => 'role:guru'], function (){
    ...
    Route::get('report-history', [ReportController::class, 'history'])->name('guru.report.history');
    Route::get('report-kelas', [ReportController::class, 'kelas'])->name('guru.report.kelas');
