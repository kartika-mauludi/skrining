...
<div class="container my-4">
    <div class="sheet">
        ...
        <div class="text-center">
            ...
            <div class="text-small">
              Alamat : {{ $kelas->sekolah->alamat_lengkap }}<br>
               No. Telephone : {{ $kelas->sekolah->no_tlp }}
            </div>
        </div>
        ...
        <div class="text-center mb-3">
            <h5 class="fw-bold">NOBUL - ( Sebagai Korban )</h5>
        </div>
        ...
        <!-- DETAIL -->
        <div class="box mb-3">
            <strong>Perlakuan perundungan yang diterima berdasarkan kriteria:</strong>
            <div class="row mt-2">
                <div class="col">Verbal: <strong>0</strong></div>
                <div class="col">Fisik: <strong>0</strong></div>
                <div class="col text-danger">Sosial: <strong>0</strong></div>
                <div class="col text-danger">Cyber: <strong>0</strong></div>
            </div>
        </div>
